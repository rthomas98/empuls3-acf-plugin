            ...
            <div class="col-sm-12 col-md-12 col-lg-6 mb-4 mb-sm-4 mb-md-4 mb-lg-0 p-5 hero-left">
                ...
                <div class="d-grid gap-2 d-md-block mt-4">
                    ...
                    <?php if ( $button_one_link ) : ?>
                        <a class="btn btn-secondary btn-lg" href="<?php echo esc_url( $button_one_link); ?>">
                    ...
                    <?php if ( $button_two_link ) : ?>
                        <a class="btn btn-secondary-outline btn-lg" href="<?php echo esc_url( $button_two_link); ?>">
